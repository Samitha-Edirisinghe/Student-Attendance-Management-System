...
<div class="jumbotron text-center" style="margin-bottom:0;padding: 15px;">
  <h1>Student Attendance System</h1>
  <h1>SLTC</h1>
</div>


<div class="container" style="background-image: url(./image/bg.jpg) !important;width: 100%;height: 490px;padding-top: 70px;margin-top: 10px;">
  <div class="row">
    <div class="col-md-4">
